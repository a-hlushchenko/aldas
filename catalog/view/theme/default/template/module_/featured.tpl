<div class="container">
  ...
  <div class="txt2">
    <?php if($heading_title=='Кухни в классическом стиле'){ ?>
...
Такая мебель, как правило, изготавливается из массива дерева и может содержать много резьбы и мелких деталей.
    <?php } elseif($heading_title=='Кухни в современном стиле'){ ?>
...
<div class="row">
  ...
  <div class="tcenter">
    <?php if($heading_title=='Кухни в классическом стиле'){ ?>
    <a href="katalog/klassicheskie/" class="bmore">Посмотреть все кухни в классическом стиле</a>
    <?php } else { ?>
    <a href="katalog/sovremennye/" class="bmore">Посмотреть все кухни в современном стиле</a>
<?php } ?>
  </div>
</div>
</div>
