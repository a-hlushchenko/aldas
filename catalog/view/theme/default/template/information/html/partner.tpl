...
<style>
	...
	h2.twhite{color: #fff;text-transform: uppercase;}
	p{line-height:23px;}
	...
	.information-information #content .row.form{background: url('images/n_aldas/partner_fon1.jpg') center top repeat;padding:10px 0 50px;margin-bottom:0;
		}
...
<div class="container information-new">
	...
	<div id="content" class="info">
		...
		<div class="designer">
			...
			<img src="/image/designer.png" alt="img">
		</div>
		...
		<div class="designer">
			<img src="/image/designer-2.png" alt="img">
			<div class="designer-content">
		...
		<div class="bl5">
			<div class="bl5_wrapper">
				...
				<div class="bl5_r"><img src="image/form-partner.png" alt="bl5_r"></div>
			</div>
		</div>
