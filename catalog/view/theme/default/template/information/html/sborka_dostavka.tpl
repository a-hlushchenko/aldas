...
<style>
	...
	@media (max-width: 920px) {
		...
		.first-description, .second-desciption {
			max-width: 700px;
		}
	}
		...
		<div class="text-center">
			...
			<div class="delivery">
				<div class="delivery-item">
					<div class="img"><img src="image/svg/delivery1.svg"></div>
				...
				<div class="delivery-item">
					<div class="img"><img src="image/svg/delivery2.svg"></div>
					<div class="delivery-text">
				...
				<div class="delivery-item">
					<div class="img"><img src="image/svg/delivery3.svg"></div>
					<div class="delivery-text">
			...
			<div class="first">
				...
				<img src="/image/delivery-first.png" alt="delivery">
			</div>

			<div class="second">
				<img src="/image/delivery-second.png" alt="delivery">
