...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="row">
        <div class="col-sm-4">
          <input type="text" name="news_search" value="<?php echo $news_search; ?>" placeholder="<?php echo $text_keyword; ?>" id="input-search" class="form-control" />
        </div>
        <div class="col-sm-3">
...
$('#button-search').bind('click', function() {
  ...
  var news_search = $('#content input[name=\'news_search\']').prop('value');

  if (news_search) {
    url += '&news_search=' + encodeURIComponent(news_search);
  }
...
$('#content input[name=\'news_search\']').bind('keydown', function(e) {
  if (e.keyCode == 13) {
