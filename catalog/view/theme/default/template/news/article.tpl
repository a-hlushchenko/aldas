  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="col-sm-12">
      ...
      <div class="dflex">
        <div>
          <?php if($prev){ ?> 
          <a href="<?php echo $prev; ?>" alt="Предыдущий отзыв" title="Предыдущий отзыв">Предыдущий отзыв</a>
          <?php } ?>
        </div>
        <div>
          <?php if($next){ ?> 
          <a href="<?php echo $next; ?>" alt="Следующий отзыв" title="Следующий отзыв">Следующий отзыв</a>
          <?php } ?>
        </div>
      </div>
