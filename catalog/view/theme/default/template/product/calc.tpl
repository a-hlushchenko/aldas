...
#modal-zakaz1{z-index: 1065;}
#modal-online-raschet .modal-dialog{width:83%;margin:auto;}
#modal-online-raschet input[type="radio"]{display:none}
#modal-online-raschet label{font-size:20px;position:relative;font-weight:normal;line-height:23px;color:#534d51;cursor:pointer}
#modal-online-raschet .modal-content{background:#fff;padding:25px;}
.id3_1.new .name2 {
    font-size: 25px;
    color: #534d51;
    margin-bottom: 15px;
...
.id3_1.new .forma_content2 {clear: both;margin-top: 20px}
.id3_1.new .endsum {font-size: 30px;margin: 15px 0;font-family: 'mariupolmedium';color: #daa769;line-height: 32px;}
.id3_1.new .tipbubble1 {display: inline;font-family: 'Lora';font-style: italic;font-size: 16px;color: #726c70;margin: 5px 15px 15px 0px;font-weight: normal;}
#modal-online-raschet input[type="radio"]:checked + label::before {content: "\2022";color: #f3f3f3;font-size: 28px;text-align: center;line-height: 16px;}
#modal-online-raschet input[type="radio"] + label::before {content: "";display: inline-block;width: 16px;height: 16px;margin-right: 10px;position: absolute;left:0;top:5px;background-color:#e74c3c;border-radius: 8px;}
#modal-online-raschet input[type="text"]{display: block;width:100%!important;line-height: 30px;background:#f1f2f4;padding: 2px;border: 1px solid #c9c6c5;}
</style>
<!--noindex-->
         ...
         <input type="hidden" name="titleforma" value="Заявка на расcчет стоимости - Страница товара"/>
            ...
            <div class="title2">Укажите параметры кухни или пришлите свой эскиз.<br/>Мы подберем и рассчитаем оптимальный вариант.</div>
             <div class="forma_content">
                <div class="fio"><div class="name control-label1">Ваше имя:</div><input type="text" name="name" value=""/>
