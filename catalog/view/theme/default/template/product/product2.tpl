              ...
              <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                  ...
                  <div class="wrapper pre_forma">
                    ...
                    <div class="tovar-button1 ff6"><a rel="nofollow" onclick="return false;">Цвета</a></div>
                    <div class="tovar-button1 ff5"><a rel="nofollow" onclick="return false;">Ткань</a></div>
