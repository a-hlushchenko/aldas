...
<body class="<?php echo $class; ?>">
	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MRD8BSP" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
					...
					<div class="h_top">
						...
						<a href="#call_design" data-modal="call_design" class="call_design btn light">
							<svg width="19" height="14" viewBox="0 0 19 14" fill="none" xmlns="http://www.w3.org/2000/svg">
								<circle cx="7.5" cy="7" r="6" stroke="#18C792" stroke-width="2" />
								<circle cx="7.5" cy="7" r="2" stroke="#18C792" stroke-width="2" />
								<rect x="7.5" y="12" width="10" height="2" fill="#18C792" />
								<rect x="16.5" y="10" width="2" height="4" fill="#18C792" />
							</svg>
				...
				<a href="#online_calc" class="online_calc" data-modal="online_calc">
					<div>
						<svg width="18" height="24" viewBox="0 0 18 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							<rect x="1" y="1.5" width="16" height="21" rx="1" stroke="white" stroke-width="2" />
							<line x1="1" y1="7.5" x2="17" y2="7.5" stroke="white" stroke-width="2" />
							<rect x="3" y="11.5" width="5" height="1" fill="white" />
							<rect x="4.08582" y="15.8787" width="5" height="1" transform="rotate(45 4.08582 15.8787)" fill="white" />
							<rect x="10" y="11.5" width="5" height="1" fill="white" />
							<rect x="10" y="16.5" width="5" height="1" fill="white" />
							<rect x="10" y="18.5" width="5" height="1" fill="white" />
							<rect x="6" y="9.5" width="5" height="1" transform="rotate(90 6 9.5)" fill="white" />
							<rect x="7.62134" y="16.5858" width="5" height="1" transform="rotate(135 7.62134 16.5858)" fill="white" />
						</svg>
