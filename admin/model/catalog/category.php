...
class ModelCatalogCategory extends Model {
	public function addCategory($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "category SET parent_id = '" . (int)$data['parent_id'] . "', `view_attibute` = '" . (isset($data['view_attibute']) ? (int)$data['view_attibute'] : 0) . "', name_attibute = '" . $this->db->escape($data['name_attibute']) . "', type_id = '" . (int)$data['type_id'] . "', `top` = '" . (isset($data['top']) ? (int)$data['top'] : 0) . "', `column` = '" . (int)$data['column'] . "', sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', date_modified = NOW(), date_added = NOW()");
	...
	public function editCategory($category_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "category SET parent_id = '" . (int)$data['parent_id'] . "', `view_attibute` = '" . (isset($data['view_attibute']) ? (int)$data['view_attibute'] : 0) . "', name_attibute = '" . $this->db->escape($data['name_attibute']) . "', type_id = '" . (int)$data['type_id'] . "', `top` = '" . (isset($data['top']) ? (int)$data['top'] : 0) . "', `column` = '" . (int)$data['column'] . "', sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', date_modified = NOW() WHERE category_id = '" . (int)$category_id . "'");
