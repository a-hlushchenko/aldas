          ...
          <div class="tab-content">
            <div class="tab-pane active in" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta_title<?php echo $language['language_id']; ?>">HTML-тег Title</label>
                    <div class="col-sm-10">
                      <input type="text" name="category_description[<?php echo $language['language_id']; ?>][meta_title]" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['meta_title'] : ''; ?>" placeholder="HTML-тег Title" id="input-meta_title<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>                  
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta_h1<?php echo $language['language_id']; ?>">HTML-тег H1</label>
                    <div class="col-sm-10">
                      <input type="text" name="category_description[<?php echo $language['language_id']; ?>][meta_h1]" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['meta_h1'] : ''; ?>" placeholder="HTML-тег H1" id="input-meta_h1<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>                  
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta_description<?php echo $language['language_id']; ?>">Мета-тег Description</label>
                    <div class="col-sm-10">
                      <textarea type="text" name="category_description[<?php echo $language['language_id']; ?>][meta_description]"  placeholder="Мета-тег Description" id="input-meta_description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
                    </div>
                  </div>                  
                </div>
                <?php } ?>
            ...
            <div class="tab-pane fade" id="tab-data">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="news_path" value="<?php echo $news_path; ?>" placeholder="<?php echo $entry_parent; ?>" id="input-parent" class="form-control" />
...
$('input[name=\'news_path\']').autocomplete({
  ...
  'select': function(item) {
    $('input[name=\'news_path\']').val(item['label']);
