        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-short_description<?php echo $language['language_id']; ?>"><?php echo $entry_description; ?> низ</label>
                    <div class="col-sm-10">
                      <textarea name="category_description[<?php echo $language['language_id']; ?>][short_description]" placeholder="<?php echo $entry_description; ?>" id="input-short_description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['short_description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-parent">Показывать в вкладке "Характеристики" на странице товара:</label>
                <div class="col-sm-10">
                  <?php if ($view_attibute) { ?>
                <input type="checkbox" name="view_attibute" value="1" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="view_attibute" value="1" />
                <?php } ?>
                Название аттрибута: <input type="text" name="name_attibute" value="<?php echo $name_attibute; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-keyword"><span data-toggle="tooltip" title="Тип атрибута">Тип атрибута:</span></label>
                <div class="col-sm-10">
                  <select name="type_id">
                    <option value="0" selected="selected"><?php echo $text_none; ?></option>
                    <?php foreach ($types as $key => $type) { ?>
                    <?php if ($key+1 == $type_id) { ?>
                    <option value="<?php echo $key+1; ?>" selected="selected"><?php echo $type; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $key+1; ?>"><?php echo $type; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
...
ckeditorInit('input-short_description<?php echo $language['language_id']; ?>', '<?php echo $token; ?>');
<?php } else { ?>
