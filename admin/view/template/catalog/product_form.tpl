        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-fasad<?php echo $language['language_id']; ?>">Материалы фасадов:</label>
                    <?php
                    $mas = array('Массив','МДФ', 'Пластик', 'Пластик и МДФ', 'ЛДСП','Эмаль','Эмаль и МДФ','Массив с патиной');
                    //$mas = array('массив','массив дуба','МДФ');
                    ?>
                    <div class="col-sm-10">
                      <select name="product_description[<?php echo $language['language_id']; ?>][fasad]" id="input-tax-class" class="form-control">
                        <option value=""><?php echo $text_none; ?></option>
                        <?php foreach ($mas as $m) { ?>
                        <?php if ($m == $product_description[$language['language_id']]['fasad']) { ?>
            ...
            <div class="tab-pane" id="tab-data">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-template">Шаблон для товара</label>
                <div class="col-sm-10">
                  <select name="template" id="input-template" class="form-control">
                    <?php if ($template==1) { ?>
                    <option value="0">Шаблон по умолчанию</option>
                    <option value="1" selected="selected">Шаблон для столов и стульев</option>
                    <option value="2">Шаблон для техники и аксессуаров</option>
                    <?php } elseif($template==2) { ?>
                    <option value="0">Шаблон по умолчанию</option>
                    <option value="1">Шаблон для столов и стульев</option>
                    <option value="2" selected="selected">Шаблон для техники и аксессуаров</option>
                    <?php } else { ?>
                    <option value="0" selected="selected">Шаблон по умолчанию</option>
                    <option value="1">Шаблон для столов и стульев</option>
                    <option value="2">Шаблон для техники и аксессуаров</option>
                    <?php } ?>
                  </select>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select id="main_category_id" name="main_category_id" class="form-control">
                    ...
                    <?php if($category['category_id'] == $main_category_id || $category['category_id']==131) { ?>
