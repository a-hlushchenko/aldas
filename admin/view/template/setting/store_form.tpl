          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-config_metrika">Метрика:</label>
                <div class="col-sm-10">
                  <textarea name="config_metrika" id="input-config_metrika" class="form-control"><?php echo $config_metrika; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-config_ga">Google Analitic:</label>
                <div class="col-sm-10">
                  <textarea name="config_ga" id="input-config_ga" class="form-control"><?php echo $config_ga; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-city"><span data-toggle="tooltip" data-html="true">Город</span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_city" value="<?php echo $config_city; ?>" placeholder="Город" id="input-city" class="form-control" />
                </div>
              </div>
              <div class="form-group">
