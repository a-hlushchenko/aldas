...
class ControllerCatalogProduct extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->request->post['model'] = 'KF-' . $this->request->post['model'];
    ...
    if (isset($this->request->get['filter_category'])) {
      ...
      $category =  $this->model_catalog_product->getProductCategories($result['product_id']);
			...
			$query = $this->db->query("SELECT keyword FROM " . DB_PREFIX . "url_alias WHERE query = 'product_id=" . (int)$result['product_id'] . "'");
    ...
    if ($this->config->get('config_editor_default')) {
		...
		if (isset($this->request->post['model'])) {
			...
			$product_info['model'] = str_replace('KF-', '', $product_info['model']);
