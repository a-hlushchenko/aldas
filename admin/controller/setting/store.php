...
class ControllerSettingStore extends Controller {
	...
	public function getForm() {
		...
		if (isset($this->request->post['config_metrika'])) {
			$data['config_metrika'] = $this->request->post['config_metrika'];
		} elseif (isset($store_info['config_metrika'])) {
			$data['config_metrika'] = $store_info['config_metrika'];
		} else {
			$data['config_metrika'] = '';
		}
		if (isset($this->request->post['config_ga'])) {
			$data['config_ga'] = $this->request->post['config_ga'];
		} elseif (isset($store_info['config_ga'])) {
			$data['config_ga'] = $store_info['config_ga'];
		} else {
			$data['config_ga'] = '';
		}
