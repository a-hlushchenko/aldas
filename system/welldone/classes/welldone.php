  ...
  class Welldone
  {
    ...
    public function js_out($position = 'header')
    {
      ...
      if ($minify_js)
      {
        ...
        echo '<script src="'.MAIN_SERVER.'system/welldone/data/cache/minify/'.$combined_js.'"></script>'."\n";
      ...
      else
      {
        ...
        {
          echo '<script src="'.MAIN_SERVER.''.$file.'"></script>'."\n";
    ...
    public function css_out($position = 'header')
    {
      ...
      if ($minify_css)
      {
        ...
        //echo '<link rel="stylesheet" href="'.MAIN_SERVER.'system/welldone/data/cache/minify/'.$combined_css_style.'">'."\n";
        echo '<link rel="stylesheet" href="'.MAIN_SERVER.'system/welldone/data/cache/minify/'.$combined_css_style.'">'."\n";
      }
      else
      {
        ...
        {
          //echo '<link rel="stylesheet" href="'.MAIN_SERVER.''.$file.'">'."\n";
          echo '<link rel="stylesheet" href="'.MAIN_SERVER.$file.'">'."\n";
        }
      }
      //Google fonts
